...
export async function validarResultadosBilhete(bilhete) {
  ...
  try {
    ...
    else if (statuses.every((status) => status === "anulada")) status_detectado = "anulada";
