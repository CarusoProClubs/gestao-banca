...
export function fecharBilhete(bilhete) {
  ...
  // Cashout/anulada são estados do bilhete inteiro escolhidos pelo usuário.
  // status_detectado é apenas uma sugestão da leitura e não fecha o bilhete sozinho.
  if (["cashout", "anulada"].includes(status_usuario)) {
